class Api::V1::GameSessionsController < ApplicationController
  ...
  def create
    ...
    if @game_session.save
      render json: @game_session, status: :created, location: api_v1_game_session_url(@game_session)
    else
  ...
  private
    ...
    def game_session_params
      params.require(:game_session).permit(:User_id, :Game_id, :total_damage_dealt, :total_damage_taken, :total_healing, :num_kills, :weapons_collected)
    end
end
